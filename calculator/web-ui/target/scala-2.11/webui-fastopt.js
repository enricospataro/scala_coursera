...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var x$3 = x3.name$2;
      var v = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x$3, references);
      expr = v;
      continue _eval
      ...
      var x$4 = x4.a$2;
      var y = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$4, references) + this.eval__Lcalculator_Expr__sci_Map__D(y, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var x$5 = x5.a$2;
      var y$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$5, references) - this.eval__Lcalculator_Expr__sci_Map__D(y$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var x$6 = x6.a$2;
      var y$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$6, references) * this.eval__Lcalculator_Expr__sci_Map__D(y$3, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var x$7 = x7.a$2;
      var y$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$7, references) / this.eval__Lcalculator_Expr__sci_Map__D(y$4, references))
    } else {
